...
/////////////////////////////////////////////////////////////////////////////////////////////////////
addBlock('basic_define_combine', '%1', {
    color: '#262626',
    outerline: '#fff',
}, {
    params: [
        {
            type: 'Block',
            accept: 'basic_text_light',
        },
    ],
    def: [
        { type: 'basic_text_light' },
    ],
    map: {},
}, 'text', (sprite, script) => {
}, 'basic_define',)
////////////////////////////////////////////////////////////////////////////////////////////////////
addBlock('basic_text_light', '%1', {
    color: '#262626',
    outerline: '#fff',
}, {
    params: [
...
`)
$('#entryCategoryMintBlocks').append('민트블록_테스트블록')
